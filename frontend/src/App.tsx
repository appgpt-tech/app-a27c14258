...
import tournamentsIcon from '@mui/icons-material/Event';
// SUPERTOKENS
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/a27c14258">
      <Admin
        authProvider={
      ...
      >
        <Resource
          ...
          edit={playersEdit}
          recordRepresentation="playerId"
          icon={playersIcon}
        />
        <Resource
          name="tournaments"
          options={{ label: 'Tournaments' }}
          list={tournamentsList}
          create={tournamentsCreate}
          edit={tournamentsEdit}
          recordRepresentation="tournamentId"
